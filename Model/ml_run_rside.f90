...
open(30, file="./Reports/mixedlayer_report/Recent/rside/" // filename //".csv")
open(31, file="./Reports/mixedlayer_report/Recent/rside/" // filename // "PARAMETERS.csv")
...
!=========================================================================
	...
	write(30, 40)  0.0 + real(testdo - 1)*0.2  ,d_mix_max,  s_mix_max, t_mix_max - 273.15
