...
open(30, file="./Reports/mixedlayer_report/Recent/snow/" // filename //".csv")
open(31, file="./Reports/mixedlayer_report/Recent/snow/" // filename // "PARAMETERS.csv")
...
snowarray = (/0.0_q, 0.1_q, 0.2_q, 0.3_q, 0.4_q, 0.5_q /)

do testdo = 1, 6

!hs = 0.0 +real(testdo - 1)*0.1
...
r_time = 0.5_q ! so 1* is one year relaxation time period for water below the mixed layer
t_mix = 273.15 + 1.0_q
s_mix = 34.0_q
exportrate = 1.0_q !how much sea ice export in a year in units of area
...
!=========================================================================
	...
	write(30, 40)  hs  ,d_mix_max,  s_mix_max, t_mix_max - 273.15
	40 format(F7.2, ",", F7.2,",", F6.2,",", F6.2)

	print *, "snow thickness", hs
