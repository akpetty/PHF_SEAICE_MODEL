...
open(30, file="./Reports/mixedlayer_report/Recent/initT/" // filename //".csv")
open(31, file="./Reports/mixedlayer_report/Recent/initT/" // filename // "PARAMETERS.csv")
...
t_mix = 273.15 - 1.5 + real(testdo - 1)*0.75
...
!=========================================================================
	...
	write(30, 40)  273.15 - 1.5 + real(testdo - 1)*0.75  ,d_mix_max,  s_mix_max, t_mix_max - 273.15
	40 format(F7.2, ",", F7.2,",", F6.2,",", F6.2)

	print *, "Initial T", 273.15 - 1.5 + real(testdo - 1)*0.75
