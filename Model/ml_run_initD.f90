...
open(30, file="./Reports/mixedlayer_report/Recent/initD/" // filename //".csv")
open(31, file="./Reports/mixedlayer_report/Recent/initD/" // filename // "PARAMETERS.csv")
...
d_mix = 1.0 +real(testdo - 1)*4
print *, "Initial D", d_mix
...
!=========================================================================
	...
	write(30, 40)  1.0 + real(testdo - 1)*3.0  ,d_mix_max,  s_mix_max, t_mix_max - 273.15
