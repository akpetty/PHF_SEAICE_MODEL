...
open(30, file="./Reports/mixedlayer_report/Recent/initS/" // filename //".csv")
open(31, file="./Reports/mixedlayer_report/Recent/initS/" // filename // "PARAMETERS.csv")
...
!=========================================================================
	...
	write(30, 40)  32.0 + real(testdo - 1)*0.5  ,d_mix_max,  s_mix_max, t_mix_max - 273.15
	40 format(F7.2, ",", F7.2,",", F6.2,",", F6.2)

	print *, "Initial S", s_mix
